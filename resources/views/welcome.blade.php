...
<head>
    ...
    <link rel=" icon" href="../img/logoIFC2.png" type="image/png">
    <title>
      IFC 2019
    </title>
    <!--     Fonts and icons     -->
        ...
        <div class="page-header header-filter">
            ...
            <div class="container" data-aos="fade-up">
                <div class="content-center brand">
                    <div class="pt-3 pb-3 mt-0 mb-1" style="background-color:  rgba(69, 199, 188,0.5); border-radius:100px; border:none;">
                        <img src="../img/logoIFC.png" class="mt-0" style="width:90%; height:auto;">
                    </div>                    
                    ...
                    <button class="btn mt-0" id="btn1" onclick="window.location.href='#sejarah'" type="button">EXPLORE!</button>
                </div>
            </div>
        </div>
        <div class="main">
          <div class="section">
            <div class="container" id="sejarah">
                <div class="title">
                  ...
                  <img src="../img/logoUKM.png" width="20%" id="logoukm" data-aos="fade-right">
                  <h3 data-aos="fade-right">UKM Sepakbola ITS Presents:</h3>
                </div>
